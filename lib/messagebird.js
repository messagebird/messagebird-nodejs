  ...
  return {
    ...
    conversations: {
      ...
      send: function (params, callback) {
        httpRequest('POST', '/conversations/send', params, callback);
      },
      ...
      start: function (params, callback) {
        httpRequest('POST', '/conversations/start', params, callback);
      },
      ...
      list: function (limit, offset, callback) {
        ...
        httpRequest('GET', '/conversations', params, callback);
      },
       ...
       */
      read: function (id, callback) {
        httpRequest('GET', '/conversations/' + id, callback);
      },
      ...
      update: function (id, params, callback) {
        httpRequest('PATCH', '/conversations/' + id, params, callback);
      },
      ...
      reply: function (id, params, callback) {
        httpRequest('POST', '/conversations/' + id + '/messages', params, callback);
      },
      ...
      listMessages: function (id, limit, offset, callback) {
        ...
        httpRequest('GET', '/conversations/' + id + '/messages', params, callback);
      },

      readMessage: function (id, callback) {
        httpRequest('GET', '/conversations/messages/' + id, callback);
      }
    ...
    contacts: {
       ...
       */
      update: function (id, params, callback) {
        httpRequest({ method: 'PATCH', path: '/contacts/' + id, params }, callback);
      },
