  ...
  return {
    ...
    hlr: {
      read: function (id, callback) {
        httpRequest ('GET', '/hlr', { id: id }, callback);
      },
    ...
    messages: {
      read: function (id, callback) {
        httpRequest ('GET', '/messages', { id: id }, callback);
      },
    ...
    voice_messages: {
      read: function (id, callback) {
        httpRequest ('GET', '/voicemessages', { id: id }, callback);
      },
    ...
    verify: {
      ...
      create: function (recipient, params, callback) {
        ...
        if (recipient instanceof Array) {
          params.recipient = recipient.join (',');
        }
      ...
      verify: function (id, token, callback) {
        httpRequest ('GET', '/verify/' + id, { token: token }, callback);
      }
    }
  };
};
