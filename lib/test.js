...
var validateSignature = require('./signature');

var MessageBird = require(root);
var messagebird;

var VOICE_ENDPOINT = 'https://voice.messagebird.com';
...
queue.push(function () {
  ...
  messagebird.transcriptions.create('call_id', 'leg_id', 'recording_id', 'language', function (err, data) {
    doTest(err, 'transcriptions.create', [
      ['type', data instanceof Object],
      ['.id', typeof data.data[0].id === 'string'],
      ['.recordingId', typeof data.data[0].recordingId === 'string'],
      ['.error', data.data[0].error === null],
      ['.createdAt', typeof data.data[0].createdAt === 'string'],
      ['.updatedAt', typeof data.data[0].updatedAt === 'string'],
